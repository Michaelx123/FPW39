"""
Django settings for lprj project.
...
SECRET_KEY = 'django-insecure-@+4swz!@qbze&p&7vgo2yxetfzr)nq@x3xxq1y1v8x%_zdu&p@'
...
LOGGING = {
    ...
    'loggers': {
        'django': {
            'handlers': ['general_log_file', 'warning_console', 'error_console', 'console_debug'],
            'level': 'DEBUG',
        },
        'django.request': {
...
WSGI_APPLICATION = 'lprj.wsgi.application'
